...
parser.add_argument('--trezor-path', dest='trezor_path', default=None,
                    help='Trezor path')
parser.add_argument('--trezor-idx', dest='trezor_idx', default=None,
                    help='Trezor path idx')
parser.add_argument('--mnemonic', dest='mnemonic', default=0, type=int,
...
client.wipe_device()
client.load_device_by_mnemonic(mnemonic=mnemonic, pin='', passphrase_protection=False, label='ph4test', language='english')
