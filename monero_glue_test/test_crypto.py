...
class CryptoTest(aiounittest.AsyncTestCase):
    ...
    def test_encoding(self):
        point = bytes(
            [0x24, 0x86, 0x22, 0x47, 0x97, 0xd0, 0x5c, 0xae, 0x3c, 0xba, 0x4b, 0xe0, 0x43, 0xbe, 0x2d, 0xb0, 0xdf, 0x38,
             0x1f, 0x3f, 0x19, 0xcf, 0xa1, 0x13, 0xf8, 0x6a, 0xb3, 0x8e, 0x3d, 0x8d, 0x2b, 0xd0])
        self.assertEqual(point, crypto.encodepoint(crypto.decodepoint(point)))
        self.assertTrue(crypto.point_eq(crypto.decodepoint(point),
                                        crypto.decodepoint(crypto.encodepoint(crypto.decodepoint(point)))))

    def test_scalarmult_base(self):
        scalar = crypto.decodeint(bytes(
            [0xa0, 0xee, 0xa4, 0x91, 0x40, 0xa3, 0xb0, 0x36, 0xda, 0x30, 0xea, 0xcf, 0x64, 0xbd, 0x9d, 0x56, 0xce, 0x3e,
             0xf6, 0x8b, 0xa8, 0x2e, 0xf1, 0x35, 0x71, 0xec, 0x51, 0x1e, 0xdb, 0xcf, 0x83, 0x03]))
        exp = bytes(
            [0x16, 0xbb, 0x4a, 0x3c, 0x44, 0xe2, 0xce, 0xd5, 0x11, 0xfc, 0x0d, 0x4c, 0xd8, 0x6b, 0x13, 0xb3, 0xaf, 0x21,
             0xef, 0xc9, 0x9f, 0xb0, 0x35, 0x61, 0x99, 0xfa, 0xc4, 0x89, 0xf2, 0x54, 0x4c, 0x09])
        ...
        scalar = crypto.decodeint(bytes(
            [0xfd, 0x29, 0x0d, 0xce, 0x39, 0xf7, 0x81, 0xae, 0xbb, 0xdb, 0xd2, 0x45, 0x84, 0xed, 0x6d, 0x48, 0xbd, 0x30,
             0x0d, 0xe1, 0x9d, 0x9c, 0x3d, 0xec, 0xfd, 0xa0, 0xa6, 0xe2, 0xc6, 0x75, 0x1d, 0x0f]))
        exp = bytes(
            [0x12, 0x3d, 0xaf, 0x90, 0xfc, 0x26, 0xf1, 0x3c, 0x65, 0x29, 0xe6, 0xb4, 0x9b, 0xfe, 0xd4, 0x98, 0x99, 0x5a,
             0xc3, 0x83, 0xef, 0x19, 0xc0, 0xdb, 0x67, 0x71, 0x14, 0x3f, 0x24, 0xba, 0x8d, 0xd5])
        res = crypto.scalarmult_base(scalar)
        self.assertEqual(exp, crypto.encodepoint(res))
        self.assertTrue(crypto.point_eq(crypto.decodepoint(exp), res))
    ...
    def test_scalarmult(self):
        priv = bytes(
            [0x34, 0x82, 0xfb, 0x97, 0x35, 0xef, 0x87, 0x9f, 0xca, 0xe5, 0xec, 0x77, 0x21, 0xb5, 0xd3, 0x64, 0x6e, 0x15,
             0x5c, 0x4f, 0xb5, 0x8d, 0x6c, 0xc1, 0x1c, 0x73, 0x2c, 0x9c, 0x9b, 0x76, 0x62, 0x0a])
        pub = bytes(
            [0x24, 0x86, 0x22, 0x47, 0x97, 0xd0, 0x5c, 0xae, 0x3c, 0xba, 0x4b, 0xe0, 0x43, 0xbe, 0x2d, 0xb0, 0xdf, 0x38,
             0x1f, 0x3f, 0x19, 0xcf, 0xa1, 0x13, 0xf8, 0x6a, 0xb3, 0x8e, 0x3d, 0x8d, 0x2b, 0xd0])
        exp = bytes(
            [0xad, 0xcd, 0x1f, 0x58, 0x81, 0xf4, 0x6f, 0x25, 0x49, 0x00, 0xa0, 0x3c, 0x65, 0x4e, 0x71, 0x95, 0x0a, 0x88,
             0xa0, 0x23, 0x6f, 0xa0, 0xa3, 0xa9, 0x46, 0xc9, 0xb8, 0xda, 0xed, 0x6e, 0xf4, 0x3d])
    ...
    def test_derivation_to_scalar(self):
        derivation = bytes(
            [0xe7, 0x20, 0xa0, 0x9f, 0x2e, 0x3a, 0x0b, 0xbf, 0x4e, 0x4b, 0xa7, 0xad, 0x93, 0x65, 0x3b, 0xb2, 0x96, 0x88,
             0x55, 0x10, 0x12, 0x1f, 0x80, 0x6a, 0xcb, 0x2a, 0x5f, 0x91, 0x68, 0xfa, 0xfa, 0x01])
        scalar = bytes(
            [0x25, 0xd0, 0x87, 0x63, 0x41, 0x4c, 0x37, 0x9a, 0xa9, 0xcf, 0x98, 0x9c, 0xdc, 0xb3, 0xca, 0xdd, 0x36, 0xbd,
             0x51, 0x93, 0xb5, 0x00, 0x10, 0x7d, 0x6b, 0xf5, 0xf9, 0x21, 0xf1, 0x8e, 0x47, 0x0e])
    ...
    def test_generate_key_derivation(self):
        key_pub = crypto.decodepoint(bytes(
            [0x77, 0x39, 0xc9, 0x5d, 0x32, 0x98, 0xe2, 0xf8, 0x73, 0x62, 0xdb, 0xa9, 0xe0, 0xe0, 0xb3, 0x98, 0x0a, 0x69,
             0x2a, 0xe8, 0xe2, 0xf1, 0x67, 0x96, 0xb0, 0xe3, 0x82, 0x09, 0x8c, 0xd6, 0xbd, 0x83]))
        key_priv = crypto.decodeint(bytes(
            [0x34, 0x82, 0xfb, 0x97, 0x35, 0xef, 0x87, 0x9f, 0xca, 0xe5, 0xec, 0x77, 0x21, 0xb5, 0xd3, 0x64, 0x6e, 0x15,
             0x5c, 0x4f, 0xb5, 0x8d, 0x6c, 0xc1, 0x1c, 0x73, 0x2c, 0x9c, 0x9b, 0x76, 0x62, 0x0a]))
        deriv_exp = bytes(
            [0xfa, 0x18, 0x8a, 0x45, 0xa0, 0xe4, 0xda, 0xcc, 0xc0, 0xe6, 0xd4, 0xf6, 0xf6, 0x85, 0x8f, 0xd4, 0x63, 0x92,
             0x10, 0x4b, 0xe7, 0x41, 0x83, 0xec, 0x00, 0x47, 0xe7, 0xe9, 0xf4, 0xea, 0xf7, 0x39])
        self.assertEqual(deriv_exp, crypto.encodepoint(crypto.generate_key_derivation(key_pub, key_priv)))
