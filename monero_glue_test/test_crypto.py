...
class CryptoTest(aiounittest.AsyncTestCase):
    ...
    def test_derivation_to_scalar(self):
        ...
        scalar = bytes([0x25,0xd0,0x87,0x63,0x41,0x4c,0x37,0x9a,0xa9,0xcf,0x98,0x9c,0xdc,0xb3,0xca,0xdd,0x36,0xbd,0x51,0x93,0xb5,0x00,0x10,0x7d,0x6b,0xf5,0xf9,0x21,0xf1,0x8e,0x47,0x0e])
